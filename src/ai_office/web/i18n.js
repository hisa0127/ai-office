...
const STRINGS = {
  ja: {
    working: '稼働', idle: '待機', stalled: '長時間',
    live: 'LIVE', connecting: '接続中', down: '切断',
    legendWorking: '作業中（着席）', legendIdle: '待機中（歩行）', legendStalled: '長時間稼働（60分以上）',
    legendHint: 'クリックで詳細',
    roomWork: '作業部屋', roomBreak: '休憩室',
    legendWork: '作業部屋にいる＝仕事中', legendBreak: '休憩室にいる＝手が空いている',
    cardBoss: 'あなた', cardStalled: '長時間かかっているもの', cardProjects: '進行中の案件', cardTimeline: '業務ログ',
    ...
    noStalled: '長時間のものなし', noProjects: '案件なし', noTimeline: 'まだ記録がありません',
  ...
  en: {
    working: 'Working', idle: 'Idle', stalled: 'Long-running',
    live: 'LIVE', connecting: 'connecting', down: 'offline',
    legendWorking: 'Working (at desk)', legendIdle: 'Idle (walking)', legendStalled: 'Long-running (60+ min)',
    ...
    cardBoss: 'You', cardStalled: 'Long-running', cardProjects: 'Projects', cardTimeline: 'Activity',
    ...
    noStalled: 'Nothing long-running', noProjects: 'No projects', noTimeline: 'No activity yet',
...
/** 状態 → 表示名 */
const STATUS_LABEL = {
  ja: { working: '作業中', idle: '待機中', stalled: '長時間稼働' },
  en: { working: 'working', idle: 'idle', stalled: 'long-running' },
};
